<template>
  <div>
    <div class="main-header">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" @click="github" width="30" height="30" viewBox="0 0 24 24">
        <path
...
import { validateInputTableSize, type InputTable, validateInputTable } from './core';
...
function github() {
  window.open('https://github.com/SoprachevAK/sppr')
}
